	...
	public class IndoNumeroController {
		...
		private int TMAX = 7; //in 7 tentativi riesco a trovare un numero tra 1 e 100
	    ...
	    void handleNuova(ActionEvent event) {
	    	...
	    	this.segreto = (int)(Math.random()*NMAX) +1; //genero numero random tra 1 e 100
	    	this.tentativi = 0;
	    	this.inGame = true;
	    	...
	    	txtLog.appendText(String.format("Indovina un numero tra %d e %d.\n", 1, NMAX));
